...
namespace NeoCoco
{
	...
	{           // action of finite automaton
		public NodeType Type;           // type of action symbol: clas, chr
		...
		public Action(NodeType typ, int sym, int tc)
		{
			this.Type = typ;
			this.sym = sym;
			this.tc = tc;
