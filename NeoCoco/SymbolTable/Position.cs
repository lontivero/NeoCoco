...
namespace NeoCoco
{
	public record Position
	{
		...
		public int Begin { get; }      // start relative to the beginning of the file
		public int End { get; }        // end of stretch
		public int Column { get; }     // column number of start position
		public int Line { get; }       // line number of start position
